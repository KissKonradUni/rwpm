...
A simple but effective utility to manage different packs (and save data folders) for RimWorld installations. It just works! 🛠️

> **TL;DR:** Switch between different RimWorld mod/save setups with one click. Works with multiple RimWorld versions too.
...
RimWorld Packs Manager (or as I like to call it, "That Mod Pack Switcher Thingy") allows you to create and manage different "packs" for your RimWorld installations. Each pack is stored as a subfolder within your RimWorld installation folder and represents a separate save data folder and distinct config folder, allowing you to:
...
- 📁 **Pack Management** - Creates and manages separate mod/save environments (stored as subfolders in your RimWorld installation directory) with zero conflicts
...
In theory it should work with SOME modification. I DO use Linux but I do not mod it with the Linux build because it's jank as hell. And I don't know how would I make this work with Proton. So I game on Windows. Welp.
